"""
API routes for PPB license verification
"""
...
def init_service(app):
    ...
    logger.info("PPB service initialized")
...
def index():
    ...
    return jsonify({
        "service": "PPB Facilities License Verification Microservice",
        "version": __version__,
        "description": "Verify Kenya PPB facility licenses with complete details",
        "endpoints": {
            "info": "GET /",
            "health": "GET /health",
            "ready": "GET /ready",
...
def readiness_check():
    ...
    # - Cache connectivity
    # - PPB portal reachability (with timeout)
...
def verify_license():
    """
    Verify a pharmacy license with complete detailed information
    ...
    Response:
    {
        ...
        "data": {
            ...
            "registration_number": "PPB/C/9222",
            ...
            "verified_at": "2025-01-15T20:30:00Z"
        }
    }
    """
    ...
    try:
        ...
        logger.info(f"Verifying license: {payload.ppb_number}")
