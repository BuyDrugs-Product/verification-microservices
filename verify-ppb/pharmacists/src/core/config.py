"""
Configuration settings for PPB Pharmacist License Verification Service
...
class Config:
    ...
    SERVICE_NAME = "PPB Pharmacist License Verification Microservice"
    VERSION = __version__
    DEBUG = os.environ.get("DEBUG", "false").lower() == "true"
    HOST = os.environ.get("HOST", "0.0.0.0")
    PORT = int(os.environ.get("PORT", "5002"))  # Different port from facilities (5000) and pharmtechs (5001)
    ...
    REDIS_URL = os.environ.get("REDIS_URL", "redis://localhost:6379/2")  # Different DB from facilities and pharmtechs
